...
function Topbar() {
  // LocalStorage से यूजर का नाम निकाल रहे हैं
  const user = JSON.parse(localStorage.getItem("user") || "{}");
  const userName = user.name || "Admin";

  return (
    <nav className="h-20 border-b border-slate-100 bg-white/80 backdrop-blur-md sticky top-0 z-40 px-10 flex items-center justify-between">
      ...
      <div className="flex items-center gap-6">
        ...
        >
          <div className="text-right hidden md:block">
            ...
            <p className="text-[10px] font-bold text-blue-500 uppercase tracking-widest">Verified Editor</p>
          </div>
